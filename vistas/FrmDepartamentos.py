...
"background-color: rgb(255, 255, 255)")
        ...
        self.tw_registroDepartamentos = QtWidgets.QTableWidget(FrmDepartamentos)
        self.tw_registroDepartamentos.setGeometry(QtCore.QRect(20, 400, 641, 181))
        self.tw_registroDepartamentos.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        self.tw_registroDepartamentos.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.tw_registroDepartamentos.setSelectionMode(QtWidgets.QAbstractItemView.SingleSelection)
        self.tw_registroDepartamentos.setSelectionBehavior(QtWidgets.QAbstractItemView.SelectRows)
        self.tw_registroDepartamentos.setObjectName("tw_registroDepartamentos")
        self.tw_registroDepartamentos.setColumnCount(3)
        self.tw_registroDepartamentos.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.tw_registroDepartamentos.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.tw_registroDepartamentos.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.tw_registroDepartamentos.setHorizontalHeaderItem(2, item)
        self.tw_registroDepartamentos.horizontalHeader().setDefaultSectionSize(120)
        self.tw_registroDepartamentos.horizontalHeader().setStretchLastSection(True)

        self.retranslateUi(FrmDepartamentos)
        QtCore.QMetaObject.connectSlotsByName(FrmDepartamentos)
        FrmDepartamentos.setTabOrder(self.btn_limpiar, self.btn_agregar)
        FrmDepartamentos.setTabOrder(self.btn_agregar, self.btn_editar)
        FrmDepartamentos.setTabOrder(self.btn_editar, self.btn_eliminar)
        FrmDepartamentos.setTabOrder(self.btn_eliminar, self.le_identificador)
        ...
        FrmDepartamentos.setTabOrder(self.le_buscador, self.btn_buscar)
        FrmDepartamentos.setTabOrder(self.btn_buscar, self.tw_registroDepartamentos)
    ...
    def retranslateUi(self, FrmDepartamentos):
        ...
        item = self.tw_registroDepartamentos.horizontalHeaderItem(0)
        item.setText(_translate("FrmDepartamentos", "ID"))
        item = self.tw_registroDepartamentos.horizontalHeaderItem(1)
        item.setText(_translate("FrmDepartamentos", "Nombre"))
        item = self.tw_registroDepartamentos.horizontalHeaderItem(2)
        item.setText(_translate("FrmDepartamentos", "Localización"))
